					...
					<div class="d-flex flex-column text-center">
						<form action="mem_login" method="post">
							<div class="form-group">
								<input type="hidden" name=url value="sup_show_iron"> <input
		...
		<div class="row">
			...
			<div class="col-lg-2 col-md-4 col-sm-3" id="list1"
				...
				<form action=<%=action%> style="text-align: right">
					<input type="hidden" name="seq"
						value=<%=Siron.get(i).getSup_seq()%>> <input type="hidden"
						name="id" value=<%=dto.getMem_id()%>> <input type="hidden"
						name="url" value="sup_show_zinc5">
					<button type="submit">
						<img alt="" src=<%=src%>>
					</button>
				</form>
				...
				%>
				<a href=<%=Siron.get(i).getSup_link()%>
					class="fa fa-bookmark pull-right"></a> <img
					src=<%=Siron.get(i).getSup_img()%> class="card-img-top" alt="...">
				<div class="card-body">
			...
			<nav class="main__menu">
				<ul class="nav__menu">
					...
					<li><a href="./suggest2jsp" target="_blank">영양제 추천</a></li>
...
<div class="supplements_container">
		<div class="row">
			...
			<div class="col-lg-2 col-md-4 col-sm-3" id="list1"
				...
				<div class="card-body">
					<h5 class="card-title"><%=Siron.get(i).getSup_name()%></h5>
					<p class="card-text" style="text-align: center;"><%=Siron.get(i).getSup_price()%>원
					</p>
					<p class="card-text"><%=Siron.get(i).getSup_description()%></p>
					<p class="card-text"><%=Siron.get(i).getSup_func()%></p>
				</div>
			</div>
			<%
			}
