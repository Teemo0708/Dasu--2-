					...
					<div class="d-flex flex-column text-center">
						<form action="mem_login" method="post">
							<div class="form-group">
								<input type="hidden" name=url value="sup_show_omega2"> <input
...
<div class="supplements_container">
	...
	outline: 0;" >
				...
				%>
				<a href=<%=SO.get(i).getSup_link()%>
					> <img
					src=<%=SO.get(i).getSup_img()%> class="card-img-top" alt="...">
				</a>
				<div class="card-body">
					<h5 class="card-title"><%=SO.get(i).getSup_name()%></h5>
					<p class="card-text" style="text-align: center;"><%=SO.get(i).getSup_price()%>원
					</p>
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination justify-content-center">
					...
					<li class="page-item"><a class="page-link" id="sp_page"
						href="sup_show_omega">1</a></li>
					<li class="page-item"><a class="page-link" id="sp_page"
						href="sup_show_omega2">2</a></li>
					<li class="page-item"><a class="page-link" id="sp_page"
						href="sup_show_omega3">3</a></li>
					<li class="page-item"><a class="page-link" id="sp_page"
						href="sup_show_omega4">4</a></li>
					<li class="page-item"><a class="page-link" id="sp_page"
						href="sup_show_omega5">5</a></li>
					<li class="page-item"><a class="page-link" href="#"
