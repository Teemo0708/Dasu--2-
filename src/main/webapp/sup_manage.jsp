...
<!-- 					<caption>
					...
					%>
					<tr>
						<td><%=dto.getSup_seq()%></td>
						<td><%=dto.getSup_name()%></td>
						<td style="overflow:hidden; white-space:nowrap; text-overflow:ellipsis; max-width:140px;"><%=dto.getSup_description()%></td>
						<td><%=dto.getSup_price()%></td>
						<td style="overflow:hidden; white-space:nowrap; text-overflow:ellipsis; max-width:140px;"><%=dto.getSup_link()%></td>
						<td style="overflow:hidden; white-space:nowrap; text-overflow:ellipsis; max-width:140px;"><%=dto.getSup_img()%></td>
					</tr>
					<%
					}
					%>
