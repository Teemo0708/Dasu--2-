...
<body>
	...
	%>
	<%
	ArrayList<SupDTO> SVA = (ArrayList<SupDTO>) request.getAttribute("SVA");
	%>
	<%
					...
					<div class="d-flex flex-column text-center">
						<form action="mem_login" method="post">
							<div class="form-group">
								<input type="hidden" name=url value="sup_show_vitaA3"> <input
				...
				<div class="col-sm-4 col-md-3 order-2 order-sm-1">
					<div class="header__social">
						...
						<form action="LogoutService">
							<input type="hidden" name="url" value="sup_show_vitaA3">
							<button type="submit">
		...
		<div class="row">
			...
			<div class="col-lg-2 col-md-4 col-sm-3" id="list1"
				...
				for (markupDTO mdto : ML) {
					if (mdto.getSup_seq() == SVA.get(i).getSup_seq()) {
				...
				<form action=<%=action%> style="text-align: right">
					<input type="hidden" name="seq" value=<%=SVA.get(i).getSup_seq()%>>
					<input type="hidden" name="id" value=<%=dto.getMem_id()%>>
				...
				%>
				<a href=<%=SVA.get(i).getSup_link()%>
					class="fa fa-bookmark pull-right"> <img
					src=<%=SVA.get(i).getSup_img()%> class="card-img-top" alt="...">
				</a>
				<div class="card-body">
					<h5 class="card-title"><%=SVA.get(i).getSup_name()%></h5>
					<p class="card-text" style="text-align: center;"><%=SVA.get(i).getSup_price()%>원
					</p>
					<p class="card-text"><%=SVA.get(i).getSup_description()%></p>
					<p class="card-text"><%=SVA.get(i).getSup_func()%></p>
				</div>
			</div>
			<%
			}
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination">
					...
					<li class="page-item active"><a class="page-link"
						href="sup_show_vitaA">1</a></li>
					<li class="page-item"><a class="page-link"
						href="sup_show_vitaA2">2</a></li>
					<li class="page-item"><a class="page-link"
						href="sup_show_vitaA3">3</a></li>
					<li class="page-item"><a class="page-link"
						href="sup_show_vitaA4">4</a></li>
					<li class="page-item"><a class="page-link"
						href="sup_show_vitaA5">5</a></li>
					<li class="page-item"><a class="page-link" href="#"
