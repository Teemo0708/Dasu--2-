...
<body>
	...
	<div class="modal fade" id="loginModal" tabindex="-1" role="dialog"
					...
					<div class="d-flex flex-column text-center">
						<form action="mem_login" method="post">
							<div class="form-group">
								<input type="hidden" name=url value="sup_show_milk4"> <input
		...
		<!-- Header 끝 -->
		<h3 class="sp_h3">Milkthistle(밀크시슬)</h3>
...
<div class="supplements_container">
		<div class="row">
			...
			<div class="col-lg-2 col-md-4 col-sm-3" id="list1"
				...
				%>
				<a href=<%=SI.get(i).getSup_link()%>
					class="fa fa-bookmark pull-right"> <img
					src=<%=SI.get(i).getSup_img()%> class="card-img-top" alt="...">
				</a>
				<div class="card-body">
					<h5 class="card-title"><%=SI.get(i).getSup_name()%></h5>
					<p class="card-text" style="text-align: center;"><%=SI.get(i).getSup_price()%>원
					</p>
