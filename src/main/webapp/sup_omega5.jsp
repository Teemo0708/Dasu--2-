			...
			<div class="row">
				<div class="col-sm-4 col-md-3 order-2 order-sm-1">
					...
					<% if(dto==null){ %>
						...
						<input type="hidden" name = "url" value="sup_show_omega5" >
						<button type="submit" style=" background: none; border: 0; outline: 0;"><i class="login">logout</i></button>
						</form>
				  		<%} %>   
			...
			<div class="col-lg-2 col-md-4 col-sm-3" id="list1"
				...
				<form action=<%=action%> style="text-align: right">
					<input type="hidden" name="seq"
						value=<%=SO.get(i).getSup_seq()%>> <input type="hidden"
						name="id" value=<%=dto.getMem_id()%>> <input type="hidden"
						name="url" value="sup_show_omega5">
					<button type="submit">
						<img alt="" src=<%=src%>>
					</button>
				</form>
				...
				<div class="card-body">
					...
					<p class="card-text"><%=SO.get(i).getSup_price()%></p>
				</div>
			</div>
			<%
			}
