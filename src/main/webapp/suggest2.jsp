				...
				<div class="modal-content">
						...
						<div class="d-flex flex-column text-center">
							<form action="mem_login" method="post">
								<div class="form-group">
									<input type="hidden" name="url" value="suggest2.jsp"> <input
					...
					<div class="modal-footer d-flex justify-content-center">
						<div class="signup-section">
							Not a member yet? <a href="/join.html" class="text-info">
								Sign Up</a>.
						</div>
					</div>
				</div>
	...
	outline: 0;" ><i class="login">logout</i></button>
		...
		<div class="container">
			<article class="start">
				...
				<h2 class="sub-title mt-3 text-center">
					<strong>나는 무슨 영양소가 필요할까?</strong>
				</h2>
				<img class="updown-slash mt-5"
					src="./sunia_survey/img/vitamins_PNG39.png" alt="up-slash">
			...
			<article class="question">
				<div class="progress mt-5">
					<div class="progress-bar" role="progressbar"
						style="width: calc(100/ 28 * 1%)"></div>
				</div>
				<h2 id="title" class="question-content text-center mt-4 mb-4">문제</h2>
				<input id="type" type="hidden" value="EI">
				<div class="rectangle mt-5"></div>
				<button id="A" type="button"
					class="btn-answer btn btn-primary pt-4 pb-4">대답A</button>
				<button id="B" type="button"
					class="btn-answer btn btn-primary pt-4 pb-4">대답B</button>
				<div class="rectangle"></div>

				<article class="logo">
					<span class="mt-2 text-center copyright-text">Copyright 2021
						EVENT EFFECT all rights reserved</span>
				</article>
			...
			<input type="hidden" id="종합영양제" value="0"> <input
				type="hidden" id="루테인" value="0"> <input type="hidden"
				id="종합비타민" value="0"> <input type="hidden" id="비타민A"
				value="0"> <input type="hidden" id="비타민B" value="0">
			<input type="hidden" id="비타민C" value="0"> <input
				type="hidden" id="비타민D" value="0"> <input type="hidden"
				id="오메가3" value="0"> <input type="hidden" id="밀크씨슬"
				value="0"> <input type="hidden" id="철분" value="0"> <input
				type="hidden" id="마그네슘" value="0"> <input type="hidden"
				id="아연" value="0"> <input type="hidden" id="프로폴리스" value="0">
			...
			<script>
				...
				var q = {
					...
					2 : {
						"title" : "면역력이 약해진 것을 느끼거나 걱정하고 계신가요?",
						"type" : "비타민E",
						"A" : "네 그렇습니다",
						"B" : "아니요"
					},
					...
					3 : {
						"title" : "최근 야맹증, 안구건조, 피부각질을 겪고 있나요?",
						"type" : "비타민A",
						"A" : "네 그렇습니다",
						"B" : "아니요"
					},
					...
					4 : {
						"title" : "입 주위에 부스럼, 체중감소 우울증을 겪고 있나요?",
						"type" : "비타민B",
						"A" : "네 그렇습니다",
						"B" : "아니요"
					},
					...
					5 : {
						"title" : "쇠약감이나 잇몸출혈, 더딘 상처회복을 겪고 있나요?",
						"type" : "비타민C",
						"A" : "네 그렇습니다",
						"B" : "아니요"
					},
					...
					6 : {
						"title" : "근육 경련이나 골밀도에 이상이 있다는 진단을 받으셨나요?",
						"type" : "비타민D",
						"A" : "네 그렇습니다",
						"B" : "아니요"
					},
					...
					7 : {
						"title" : "손 끝이 트고 갈라지거나 손발톱이 잘 부러지나요?",
						"type" : "오메가3",
						"A" : "네 그렇습니다",
						"B" : "아니요"
					},
					...
					9 : {
						"title" : "입 주변이 갈라지거나 편두통이 자주 생기나요?",
						"type" : "마그네슘",
						"A" : "네 그렇습니다",
						"B" : "아니요"
					},
