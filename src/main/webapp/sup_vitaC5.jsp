...
<body>
			  ...
			  <div class="d-flex flex-column text-center">
						<form action="mem_login" method="post">
							<div class="form-group">
								<input type="hidden" name=url value="sup_show_vitaC5"> 
								<input
	...
	<div class="col-lg-2 col-md-4 col-sm-3" id ="list1" style="width: 18rem;">
		...
		<%}%>
		<a href=<%=SVC.get(i).getSup_link() %> class="fa fa-bookmark pull-right">
		<img src=<%=SVC.get(i).getSup_img() %> class="card-img-top" alt="...">
		</a>
		<div class="card-body">
		  <h5 class="card-title"><%= SVC.get(i).getSup_name() %></h5>
		  <p class="card-text" style="text-align: center;"><%= SVC.get(i).getSup_price()%>원</p>
