					...
					<div class="d-flex flex-column text-center">
						<form action="mem_login" method="post">
							<div class="form-group">
								<input type="hidden" name=url value="sup_show_lacto2"> <input
	...
	<div class="supplements_container">
		<div class="row">
			...
			<div class="col-lg-2 col-md-4 col-sm-3" id="list1"
				...
				%>
				<a href=<%=SL.get(i).getSup_link()%>
					class="fa fa-bookmark pull-right"> <img
					src=<%=SL.get(i).getSup_img()%> class="card-img-top" alt="...">
				</a>
				<div class="card-body">
					<h5 class="card-title"><%=SL.get(i).getSup_name()%></h5>
					<p class="card-text" style="text-align: center;"><%=SL.get(i).getSup_price()%>원
					</p>
