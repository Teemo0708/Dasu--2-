...
<body>
	...
	%>
	<%
	ArrayList<SupDTO> SO = (ArrayList<SupDTO>) request.getAttribute("SO");
	%>
	<!-- Modal -->
	<div class="container">
					...
					<div class="d-flex flex-column text-center">
						<form action="" method="post">
							<div class="form-group">
								<input type="hidden" name=url value="item_mag.jsp"> <input
						...
						<div class="text-center text-muted delimiter">or use a
							social network</div>
						<div class="d-flex justify-content-center social-buttons">
							...
							<button type="button" onclick="fnFbCustomLogin();"
								class="btn btn-secondary btn-round" data-toggle="tooltip"
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-4 col-md-3 order-2 order-sm-1">
					<div class="header__social">
						...
						<a data-toggle="modal" href="#loginModal"
							class="btn btn-info btn-round"><i class="login">Login</i></a>
						<%
						} else {
						%>
						<a href="LogoutService">Logout</a>
						<!-- 확인 -->
						<a data-toggle="modal" href="LogoutService"
							class="btn btn-info btn-round"><i class="logout">Logout</i></a>
						<%
						}
						%>
					</div>
				...
				<div class="col-sm-4 col-md-3 order-3 order-sm-3">
					<div class="header__switches">
						...
						<a href="#" class="nav-switch"><i class="fa fa-bars"></i></a> <a
							href="bookmark.jsp"><i class="fa fa-bookmark"></i></a>
					</div>
				</div>
			</div>
			<nav class="main__menu">
				<ul class="nav__menu">
					...
					<li><a href="./supplements.jsp">영양제</a>
						<ul class="sub__menu">
							...
							<li><a href="sup_show_iodine">요오드(아이오딘)</a></li>
					...
					<li><a href="./hospital.html">가까운 병원 찾기</a> <!-- <ul class="sub__menu">
								<li><a href="./blog-single.html">내과</a></li>
								<li><a href="./blog-single.html">외과</a></li>
							</ul> --></li>
				</ul>
			</nav>
		</div>
	...
	<section>
		<!-- <div align="center"> -->
				...
				<%for (SupDTO sdto : SO) {%>		
					<a class="gallery__item fresco"
						href=<%= sdto.getSup_link() %>
						data-fresco-group="gallery"> 
						<img src=<%=sdto.getSup_img() %> alt="">
					</a>
					<span><%=sdto.getSup_name() %></span>
					<span><%=sdto.getSup_price() %></span>
				<%
				}
				%>
				</div>
		<%-- <table style="table-layout: fixed">
				...
				%>
				<tr>
					<td><%=sdto.getSup_seq()%></td>
					<td><%=sdto.getSup_name()%></td>
					<td
						style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis; max-width: 140px;"><%=sdto.getSup_description()%></td>
					<td><%=sdto.getSup_price()%></td>
					<td
						style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis; max-width: 140px;"><%=sdto.getSup_link()%></td>
					<td><img src="<%=sdto.getSup_img()%>" alt=""></td>
				</tr>
				<%
				}
				%> --%>
