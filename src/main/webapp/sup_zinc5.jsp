...
<body>
	...
	<%if(dto!=null){System.out.print("123");} %>
	<%ArrayList<SupDTO> SZ = (ArrayList<SupDTO>) request.getAttribute("SZ");%>
	...
	<!-- if (dto!=null&&ML!=null) -->
		...
		if(mdto.getSup_seq()==SZ.get(i).getSup_seq()) 
		{ 
		...
		<input type="hidden" name="seq" value=<%=SZ.get(i).getSup_seq()%>>
		<input type="hidden" name="id" value=<%=dto.getMem_id()%>>
		<input type="hidden" name="url" value="sup_show_zinc5">
		<button type="submit"><img alt="" src=<%=src %>></button>
		</form>
		<%}%>
		<a href=<%=SZ.get(i).getSup_link() %> class="fa fa-bookmark pull-right">
		<img src=<%=SZ.get(i).getSup_img() %> class="card-img-top" alt="...">
		</a>		
		<div class="card-body">
		  <h5 class="card-title"><%= SZ.get(i).getSup_name() %></h5>
		  <p class="card-text" style="text-align: center;"><%= SZ.get(i).getSup_price()%>원</p>
		  <p class="card-text"><%= SZ.get(i).getSup_description()%></p>
		  <p class="card-text"><%= SZ.get(i).getSup_func() %></p>
		</div>
	  </div>
	
<%-- 		<%else{ %>
		<% if (dto!=null) {%>
		<form action="markup_insert" style="text-align: right">
		<input type="hidden" name="seq" value=<%=SZ.get(i).getSup_seq()%>>
		<input type="hidden" name="id" value=<%=dto.getMem_id()%>>
		<input type="hidden" name="url" value="sup_show_zinc5">
		<button type="submit"><img alt="" src="img/bookmark.png"></button>
		</form>
		<%} %>
		<a href=<%=SZ.get(i).getSup_link() %> class="fa fa-bookmark pull-right">
		<img src=<%=SZ.get(i).getSup_img() %> class="card-img-top" alt="...">
	...
	<div class="paging-div">
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination">
					...
					<li class="page-item active"><a class="page-link" href="sup_show_zinc">1</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_zinc2">2</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_zinc3">3</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_zinc4">4</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_zinc5">5</a></li>
					<li class="page-item"><a class="page-link" href="#"
