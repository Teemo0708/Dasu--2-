...
@WebServlet("/sup_show_lutein2")
public class sup_show_lutein2 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		SupDAO dao = new SupDAO();
		
		ArrayList<SupDTO> list = dao.sup_showLutein(); 
		...
		RequestDispatcher rd =  request.getRequestDispatcher("sup_lutein2.jsp");
