...
<body>
	...
	<%ArrayList<SupDTO> Siron = (ArrayList<SupDTO>) request.getAttribute("Siron");%>
			  ...
			  <div class="d-flex flex-column text-center">
						<form action="mem_login" method="post">
							<div class="form-group">
								<input type="hidden" name=url value="sup_show_iron">
								<input
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-4 col-md-3 order-2 order-sm-1">
					...
					<% if(dto==null){ %>
						...
						<input type="hidden" name = "url" value="sup_show_iron3" >
			...
			<nav class="main__menu">
				...
				<% if(dto!=null&&dto.getMem_id().equals("admin")){ %>
					...
					<li><a href="./sugggest2.jsp" target="_blank">영양제 추천</a></li>
	...
	<div class="col-lg-2 col-md-4 col-sm-3" id ="list1" style="width: 18rem;">
		...
		if(mdto.getSup_seq()==Siron.get(i).getSup_seq()) 
		{ 
		...
		<input type="hidden" name="seq" value=<%=Siron.get(i).getSup_seq()%>>
		<input type="hidden" name="id" value=<%=dto.getMem_id()%>>
		<input type="hidden" name="url" value="sup_show_zinc5">
		<button type="submit"><img alt="" src=<%=src %>></button>
		</form>
		<%}%>
		<a href=<%=Siron.get(i).getSup_link() %> class="fa fa-bookmark pull-right"></a>
		<img src=<%=Siron.get(i).getSup_img() %> class="card-img-top" alt="...">
		<div class="card-body">
		  <h5 class="card-title"><%= Siron.get(i).getSup_name() %></h5>
		  <p class="card-text"><%= Siron.get(i).getSup_price()%></p>
		</div>
	  </div>
	<%}%>
	<div class="paging-div">
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination">
					...
					<li class="page-item active"><a class="page-link" href="sup_show_iron">1</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_iron2">2</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_iron3">3</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_iron4">4</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_iron5">5</a></li>
					<li class="page-item"><a class="page-link" href="#"
