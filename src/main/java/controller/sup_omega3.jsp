...
<body>
					...
					<div class="d-flex flex-column text-center">
						<form action="mem_login" method="post">
							<div class="form-group">
								<input type="hidden" name=url value="sup_show_omega3">
								<input
	...
	<div class="col-lg-2 col-md-4 col-sm-3" style="width: 18rem;">
		...
		if(mdto.getSup_seq()==SO.get(i).getSup_seq()) 
		{ 
		...
		<input type="hidden" name="seq" value=<%=SO.get(i).getSup_seq()%>>
		<input type="hidden" name="id" value=<%=dto.getMem_id()%>>
		<input type="hidden" name="url" value="sup_show_zinc5">
		<button type="submit"><img alt="" src=<%=src %>></button>
		</form>
		<%}%>
		<a href=<%=SO.get(i).getSup_link() %> class="fa fa-bookmark pull-right">
		<img src=<%=SO.get(i).getSup_img() %> class="card-img-top" alt="...">
		</a>

		<div class="card-body">
		  <h5 class="card-title"><%= SO.get(i).getSup_name() %></h5>
		  <p class="card-text" style="text-align: center;"><%= SO.get(i).getSup_price()%>원</p>
		  <p class="card-text"><%= SO.get(i).getSup_description()%></p>
		  <p class="card-text"><%= SO.get(i).getSup_func() %></p>
		</div>
	  </div>
	<%}%>
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination">
					...
					<li class="page-item active"><a class="page-link" href="sup_show_omega">1</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_omega2">2</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_omega3">3</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_omega4">4</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_omega5">5</a></li>
					<li class="page-item"><a class="page-link" href="#"
