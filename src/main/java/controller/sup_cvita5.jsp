...
<body>
	...
	<%ArrayList<SupDTO> SCV = (ArrayList<SupDTO>) request.getAttribute("SCV");%>
			  ...
			  <div class="d-flex flex-column text-center">
						<form action="mem_login" method="post">
							<div class="form-group">
								<input type="hidden" name=url value="sup_show_cvita5">
								<input
			...
			<div class="row">
				<div class="col-sm-4 col-md-3 order-2 order-sm-1">
					...
					<% if(dto==null){ %>
						...
						<input type="hidden" name = "url" value="sup_show_cvita" >
	...
	<div class="col-lg-2 col-md-4 col-sm-3" id ="list1" style="width: 18rem;">
		...
		if(mdto.getSup_seq()==SCV.get(i).getSup_seq()) 
		{ 
		...
		<input type="hidden" name="seq" value=<%=SCV.get(i).getSup_seq()%>>
		<input type="hidden" name="id" value=<%=dto.getMem_id()%>>
		<input type="hidden" name="url" value="sup_show_zinc5">
		<button type="submit"><img alt="" src=<%=src %>></button>
		</form>
		<%}%>
		<a href=<%=SCV.get(i).getSup_link() %> class="fa fa-bookmark pull-right">
		<img src=<%=SCV.get(i).getSup_img() %> class="card-img-top" alt="...">
		</a>		
		<div class="card-body">
		  <h5 class="card-title"><%= SCV.get(i).getSup_name() %></h5>
		  <p class="card-text" style="text-align: center;"><%= SCV.get(i).getSup_price()%>원</p>
		  <p class="card-text"><%= SCV.get(i).getSup_description()%></p>
		  <p class="card-text"><%= SCV.get(i).getSup_func() %></p>
		</div>
	  </div>
	<%}%>
	<div class="paging-div">
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination">
					...
					<li class="page-item active"><a class="page-link" href="sup_show_cvita">1</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_cvita2">2</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_cvita3">3</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_cvita4">4</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_cvita5">5</a></li>
					<li class="page-item"><a class="page-link" href="#"
...
<footer class="text-center text-lg-start bg-light text-muted">
  ...
  <!-- Footer 끝 -->
	...
	<script src='//cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js'></script><script  src="./js/test.js"></script>
