...
<body>
	...
	<%ArrayList<SupDTO> SC = (ArrayList<SupDTO>) request.getAttribute("SC");%>
			  ...
			  <div class="d-flex flex-column text-center">
						<form action="mem_login" method="post">
							<div class="form-group">
								<input type="hidden" name=url value="sup_show_cns">
								<input
			...
			<div class="row">
				...
				<div class="col-sm-4 col-md-6 order-1  order-md-2 text-center">
					<a href="./index.jsp" class="site-logo">
						<img src="./img/DaSulogo.png" alt="" width=230px; height=230px;>
					</a>
				</div>
	...
	<h3 class="sp_h3">종합비타민(multivitamin)</h3>
	<div class="row">
	<% for(int i =0; i<12; i++){%>
	<div class="col-lg-2 col-md-4 col-sm-3" id ="list1" style="width: 18rem;">
		...
		if(mdto.getSup_seq()==SC.get(i).getSup_seq()) 
		{ 
		...
		<input type="hidden" name="seq" value=<%=SC.get(i).getSup_seq()%>>
		<input type="hidden" name="id" value=<%=dto.getMem_id()%>>
		<input type="hidden" name="url" value="sup_show_zinc5">
		<button type="submit"><img alt="" src=<%=src %>></button>
		</form>
		<%}%>
		<a href=<%=SC.get(i).getSup_link() %> class="fa fa-bookmark pull-right">
		<img src=<%=SC.get(i).getSup_img() %> class="card-img-top" alt="...">
		</a>		
		<div class="card-body">
		  <h5 class="card-title"><%= SC.get(i).getSup_name() %></h5>
		  <p class="card-text" style="text-align: center;"><%= SC.get(i).getSup_price()%>원</p>
		  <p class="card-text"><%= SC.get(i).getSup_description()%></p>
		  <p class="card-text"><%= SC.get(i).getSup_func() %></p>
		</div>
	  </div>
	<%}%>
	<div class="paging-div">
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination justify-content-center">
					...
					<li class="page-item active"><a class="page-link" href="sup_show_cns">1</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_cns2">2</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_cns3">3</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_cns4">4</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_cns5">5</a></li>
					<li class="page-item"><a class="page-link" href="#"
