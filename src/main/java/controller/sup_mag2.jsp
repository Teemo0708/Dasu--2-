...
<body>
			  ...
			  <div class="d-flex flex-column text-center">
						<form action="mem_login" method="post">
							<div class="form-group">
								<input type="hidden" name=url value="sup_show_mag2">
								 <input
	...
	<div class="col-lg-2 col-md-4 col-sm-3" id ="list1" style="width: 18rem;">
		...
		<%}%>
		<a href=<%=SM.get(i).getSup_link() %> class="fa fa-bookmark pull-right">
		<img src=<%=SM.get(i).getSup_img() %> class="card-img-top" alt="...">
		</a>
		<div class="card-body">
		  <h5 class="card-title"><%= SM.get(i).getSup_name() %></h5>
		  <p class="card-text" style="text-align: center;"><%= SM.get(i).getSup_price()%>원</p>
	...
	<div class="paging-div">
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination">
					...
					<li class="page-item active"><a class="page-link" href="sup_show_mag">1</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_mag2">2</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_mag3">3</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_mag4">4</a></li>
					<li class="page-item"><a class="page-link" href="sup_show_mag5">5</a></li>
					<li class="page-item"><a class="page-link" href="#"
